...
export const suspiciousActivities = pgTable("suspicious_activities", {
  ...
  activityTypeIdx: index("suspicious_activities_activity_type_idx").on(table.activityType)
}));
...
export const adminPaymentActions = pgTable("admin_payment_actions", {
  ...
  transactionIdIdx: index("admin_payment_actions_transaction_id_idx").on(table.transactionId)
}));
...
export const conversations = pgTable("conversations", {
  ...
  supportAgentIdIdx: index("conversations_support_agent_id_idx").on(table.supportAgentId)
}));
