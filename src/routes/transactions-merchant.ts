...
// GET /api/transactions/merchant - Get merchant transactions
router.get('/transactions/merchant', requireAuth, requireRole(['MERCHANT', 'ADMIN']), async (req, res) => {
  try {
    ...
    const totalAmount = merchantTransactions
